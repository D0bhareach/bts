...
class HelpCommandBuilder {
    ...
    public String composeHelpMessage() {
        bld.append("[-h; --help] print this help and exit if passed during application startup.\n")
                ...
                .append("This Operations are performed silently giving no indication of success or failure.\n")
                .append("<user -id 1 --assign-task 2> assign user with id = 1 to task with id = 2.\n")
                .append("<user -id 1 --drop-task 2> user with id=1 will be removed from task's with id=2.\n")
                .append("<task -id 4 --add-user 1> add user with id = 1 to task with id = 4.\n")
                .append("<task -id 3 --remove-user 1> remove user with id=1 from task with id = 3.\n")
                .append("<task -uid 3> print all tasks to the screen of they have user with id= 3 assigned to them.\n")
                .append("<project -id 5 --add-task 1> add task with id=1 to project with id=5.\n")
                .append("<project -id 1 --remove-task 2> remove task with id=2 from project with id = 1.\n\n")
